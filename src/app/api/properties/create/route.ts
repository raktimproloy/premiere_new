...
export async function POST(request: NextRequest) {
  try {
    ...
    const ownerRezPayload = {
      ...
      check_out: propertyData.checkOut || "11:00",
    ...
    const mongoPropertyData = {
      ...
      availability: {
        checkInTime: propertyData.checkIn || "15:00",
        checkOutTime: propertyData.checkOut || "11:00",
        minStay: 1,
        maxStay: 30,
      },
      policies: {
    ...
    try {
      clearCache();
      console.log('Properties cache cleared after property creation');
    } catch (cacheError) {
